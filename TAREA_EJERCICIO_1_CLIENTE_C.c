...
int  main ()
{
	...
	*/
	...
	/*
	* Se prepara una cadena con 10 caracteres y se envia, 4 letras mas
	* el \0 que indica fin de cadena en C
	*/
	strcpy (Cadena, "Hola");
	Escribe_Socket (Socket_Con_Servidor, Cadena, 10);

	/*
	* Se lee la informacion enviada por el servidor, que se supone es
	* una cadena de 11 caracteres.
	*/
	Lee_Socket (Socket_Con_Servidor, Cadena, 11);
